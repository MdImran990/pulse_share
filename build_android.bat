...
setlocal
echo ====================================================================
echo   Pulse Share - Windows Path Space Workaround Builder (Release)
echo ====================================================================
echo.
...
:: 4. Switch to virtual workspace and compile
...
echo.
echo Build run complete! If successful, your APK is ready at:
